...
function createModelModule() {
    ...
    var ImageCollectionModel = function() {
        this.imageModels = [];
        this.listeners = [];
        this.notify = function(eventType,imageModelCollection, imageModel, eventDate){
            _.each(this.listeners,
                function(listener_fn) {
                  listener_fn(eventType,imageModelCollection,imageModel,eventDate);
                }
                );
        }
    };
    ...
    _.extend(ImageCollectionModel.prototype, {
        ...
        addImageModel: function(imageModel) {
            ...
            imageModel.addListener(function(imageModel,eventTime){
              self.notify(IMAGE_META_DATA_CHANGED_EVENT,self,imageModel,eventTime);
            });
            this.notify(IMAGE_ADDED_TO_COLLECTION_EVENT,self,imageModel,currentTime);
        },
        ...
        removeImageModel: function(imageModel) {
            ...
            this.notify(IMAGE_REMOVED_FROM_COLLECTION_EVENT,self,imageModel,currentTime);
        },
